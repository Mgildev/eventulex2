		...
		<div class="collapse navbar-collapse" id="navbarNavDropdown">
			<ul class="navbar-nav ml-auto">
				<li class="nav-item active">
					<a class="nav-link" href="<?php echo site_url();?>/AdminEventos">Gestion Eventos<span class="sr-only">(current)</span></a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="<?php echo site_url();?>/eventulex/AdminUsuarios">Gestión Usuarios</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="<?php echo site_url();?>/eventulex/AdminEntradas">Gestión Entradas</a>
				</li>
					<?php
						if($this->session->has_userdata('alias')){
							...
							echo "<li class='nav-item'><a class='nav-link login' href='". site_url()."/eventulex/logoutAdmin'>Logout</a></li>";
						} else {
							echo "<li class='nav-item'><a class='nav-link login' href='". site_url()."/eventulex/loginAdmin'>Login</a></li>";
						}
					?>
			</ul>
		</div>
